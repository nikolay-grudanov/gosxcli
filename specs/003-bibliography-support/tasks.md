...
- [x] T004 [P] Add `BibliographyType` enum to `src/typst_gost_docx/ir/model.py` ✅
- [x] T005 [P] Add `CitationStyle` enum to `src/typst_gost_docx/ir/model.py` ✅
- [x] T006 [P] Add `BibliographyEntry` Pydantic model to `src/typst_gost_docx/ir/model.py` ✅
- [x] T007 Add `CitationNode` Pydantic model to `src/typst_gost_docx/ir/model.py` ✅
- [x] T008 Add `BibliographySection` Pydantic model to `src/typst_gost_docx/ir/model.py` ✅
- [x] T009 Add `BibliographyFile` class in `src/typst_gost_docx/parser/bibliography.py` ✅
- [x] T010 Implement BibTeX parser in `src/typst_gost_docx/parser/bibliography.py` ✅
...
- [x] T011 Add `bibliography_style` field to `src/typst_gost_docx/config.py` ✅
- [x] T012 Add `--bibliography-style` CLI flag in `src/typst_gost_docx/cli.py` ✅
...
- [x] T013 [P] [US1] Create test fixture `tests/fixtures/typ/bibliography/basic.typ` with @[key] citations ✅
- [ ] T014 [P] [US1] Create expected DOCX output `tests/fixtures/docx/bibliography/basic.docx` with numbered citations
- [x] T015 [P] [US1] Write unit tests for CitationNode in `tests/unit/test_bibliography.py` ✅
- [x] T016 [US1] Write integration test for inline citations in `tests/integration/test_bibliography.py` ✅

### Implementation for User Story 1

- [x] T017 [US1] Update scanner to recognize `@[key]` pattern in `src/typst_gost_docx/parser/scanner.py` ✅
- [x] T018 [US1] Update extractor to parse `@[key]` citations in `src/typst_gost_docx/parser/extractor.py` ✅
- [x] T019 [US1] Implement citation numbering logic in `src/typst_gost_docx/parser/extractor.py` ✅
  - Track unique keys in order of appearance
  - Assign sequential numbers
  - Handle repeated citations
- [x] T020 [US1] Write inline citation markers in `src/typst_gost_docx/writers/docx_writer.py` ✅
...
- [x] T021 [P] [US2] Write unit tests for BibTeX parser in `tests/unit/test_bibliography.py` ✅
- [x] T022 [P] [US2] Write tests for all BibTeX entry types in `tests/unit/test_bibliography.py` ✅

### Implementation for User Story 2

- [x] T023 [US2] Implement `#bibliography("file.bib")` parsing in `src/typst_gost_docx/parser/extractor_v2.py` ✅
- [x] T024 [US2] Implement BibliographyFile loading in `src/typst_gost_docx/ingest/project_loader.py` ✅ (uses existing TypstProjectLoader)
- [x] T025 [US2] Handle missing .bib file with warning (FR-010) ✅
- [x] T026 [US2] Handle malformed BibTeX entries with warnings ✅ (already in parser)
- [x] T027 [US2] Handle duplicate keys (use first occurrence) ✅
...
- [x] T028 [P] [US3] Write integration test for bibliography formatting in `tests/integration/test_bibliography.py` ✅
- [x] T029 [P] [US3] Create test fixture with multiple entry types for formatting tests ✅

### Implementation for User Story 3

- [x] T030 [US3] Implement bibliography section generation in `src/typst_gost_docx/writers/docx_writer.py` ✅
- [x] T031 [US3] Format entries according to ГОСТ 7.32-2017: ✅
  - Article: `1. Автор А.А. Название. Журнал. Год. С. XX-XX.`
  - Book: `2. Автор Б.Б. Название. Издательство. Год. XX с.`
  - Inproceedings: `3. Автор В.В. Название. Труды конференции. Год. С. XX-XX.`
- [x] T032 [US3] Apply hanging indent (1.25cm) for bibliography entries ✅
- [x] T033 [US3] Handle long titles with proper line wrapping ✅
...
- [x] T034 [P] [US4] Write tests for author-year style in `tests/unit/test_bibliography.py` ✅

### Implementation for User Story 4

- [x] T035 [US4] Implement author-year inline format in `src/typst_gost_docx/writers/docx_writer.py` ✅
  - Format: `(Smith, 2020)` instead of `[1]`
- [x] T036 [US4] Sort bibliography alphabetically for author-year style ✅
- [x] T037 [US4] Implement AUTHOR_YEAR bibliography formatting per ГОСТ ✅
...
- [x] T038 [P] Update README.md with bibliography documentation ✅
- [x] T039 [P] Update state.md with completed bibliography feature ✅
- [x] T040 Add warning for missing keys (FR-011) in `src/typst_gost_docx/parser/validator.py` ✅
- [x] T041 Handle incomplete entries with placeholder text ✅
- [x] T042 [P] Add inline comments to BibTeX parser in `src/typst_gost_docx/parser/bibliography.py` ✅
- [x] T043 [P] Add inline comments to bibliography formatting in `src/typst_gost_docx/writers/docx_writer.py` ✅
- [x] T044 Run full test suite and verify all tests pass ✅
