...
## Branch History Anomaly (Важное для агентов)

### Описание
Ветки 001 и 003 НЕ были созданы как отдельные feature branches:

| Номер | Spec | Ветка | PR | Статус в main |
|-------|------|-------|-----|---------------|
| 001 | ✅ | ❌ | ❌ | Не начата |
| 002 | ✅ | ✅ | ✅ | Вмержена (#1) |
| 003 | ✅ | ❌ (работа в 002) | ✅ (вмержена в 002) | Вмержена в 002 |
| 004 | ✅ | ✅ | ✅ | Вмержена (#2) |

### Как работать
1. **001 требует отдельной реализации** — spec есть, работа не начата
2. **003 работа уже в main** — bibliography реализована в ветке 002
3. При работе над 001 создавай отдельную ветку `001-enhanced-academic-support`
